...
const es: Translations = {
  ...
  friends: {
    ...
    searchButton: 'Buscar',
    noPlayerFound: 'No se encontró ningún jugador',
    incomingRequests: 'Solicitudes de amistad',
    accept: 'Aceptar',
    decline: 'Rechazar',
    remove: 'Eliminar',
    friendsList: 'Amigos',
    noFriends: 'Aún no tienes amigos — ¡agrega a alguien!',
    pendingOutgoing: 'Pendiente',
    signInPrompt: 'Inicia sesión para usar Amigos',
  },
  gameAnalysis: {
